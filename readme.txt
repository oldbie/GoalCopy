...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\goalcopy on
     Windows, /home/user/dev/goalcopy on Linux) in a file named
     goalcopy@john.henson and copy that file to
